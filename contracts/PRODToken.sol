...
contract ProductivistToken is ERC20, Pausable {
    ...
    uint256 totalSupply_ = 100000000000000; // Max supply 100.000.000 token
    ...
    function ProductivistToken(address _addressFounder) public {
        owner = _addressFounder; //TODO remove when deploying on main net and set initial value for owner attribute
        balances[_addressFounder] = totalSupply_;
        Transfer(0x0, _addressFounder, totalSupply_);
    }
